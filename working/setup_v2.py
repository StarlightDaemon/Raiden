...
payload_dir = Path('working/evaluation-package/v0.2.0/payload')
...
manifest_path = Path('working/evaluation-package/v0.2.0/manifest.json')
manifest_path.write_text(json.dumps(manifest, indent=2), encoding='utf-8')
print(f'Wrote v0.2.0 manifest with {len(entries)} files.')
